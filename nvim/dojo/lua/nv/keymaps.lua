...
-----------------------------------------------------------
map("n", "gs", "][%F)%b", { noremap = false, desc = "Go to function" })
...
-----------------------------------------------------------
-- Bufferline (claude code)
-----------------------------------------------------------
map('x', '<M-i>', function()
  require('nv.claude').copy_visual_file_reference()
end, { desc = "Copy file absolute path with line range" })
