  ...
  ------------------------------------------------------------
  {
    ...
    opts = function()
      ...
      hooks.register(hooks.type.HIGHLIGHT_SETUP, function()
        vim.api.nvim_set_hl(0, "RainbowRed", { fg = "#6c3e3e" })    -- dark red
        vim.api.nvim_set_hl(0, "RainbowOrange", { fg = "#6b4f3a" }) -- dark orange
        vim.api.nvim_set_hl(0, "RainbowYellow", { fg = "#6b5e32" }) -- dark yellow
        vim.api.nvim_set_hl(0, "RainbowGreen", { fg = "#4f5b34" })  -- dark green
        vim.api.nvim_set_hl(0, "RainbowBlue", { fg = "#3a4b6b" })   -- dark blue
        vim.api.nvim_set_hl(0, "RainbowViolet", { fg = "#4d3a6b" }) -- dark violet
      end)
      return {
        indent = {
          highlight = { "RainbowRed", "RainbowOrange", "RainbowYellow", "RainbowGreen", "RainbowBlue", "RainbowViolet" },
          char = "│", -- optional: use thin line for softer look
        },
